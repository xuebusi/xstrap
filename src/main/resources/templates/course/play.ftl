          ...
          <span class="item-label">课时<span
            ...
            <div class="dashboard-body">
                <div class="lesson-content" id="lesson-video-content" data-role="lesson-content" style="display:none;"
                     ...
                     data-fingerprint="www.chinahadoop.cn xuebusi"
                     data-user-id="60992"
