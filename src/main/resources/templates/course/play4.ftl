...
<#include "../common/header.ftl">
    <div id="content-container" class="container">
        <div class="es-section">
            ...
            <div id="id_video_container_9031868223072399976" style="width:100%;height:768px;"></div>
            <script src="https://qzonestyle.gtimg.cn/open/qcloud/video/h5/h5connect.js" charset="utf-8"></script>
            <script type="text/javascript">
                (function() {
                    var option = {
                        "auto_play": "0",
                        "file_id": "9031868223072399976",
                        "app_id": "1253363188",
                        "width": 1364,
                        "height": 768,
                        "https": 1
                    ...
                    new qcVideo.Player(
                            ...
                            "id_video_container_9031868223072399976", option);
                })()
            </script>
        </div>
    </div>
