                        ...
                        <form id="user-profile-form" class="form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 controls radios">
                                    <input type="text" id="profile_truename" name="profile[truename]" class="form-control" data-widget-cid="widget-1" data-explain="" value="收获">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 controls radios">
                                    <div id="profile_gender">
                                        ...
                                        <input type="radio" id="profile_gender_1" name="profile[gender]" required="required" value="female" checked="checked">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 controls">
                                    <textarea type="text" rows="4" maxlength="80" id="profile_signature" name="profile[signature]" class="form-control"></textarea>
                                    <div class="help-block" style="display:none;"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 controls">
                                    <textarea name="profile[about]" rows="10" id="profile_about" class="form-control" data-image-upload-url="/editor/upload?token=NjA5OTJ8dXNlcnxpbWFnZXwxNTA4MDA5MDQ3fDMzMTdkYjA1OGM3NTQwNTI4MzViMzEwNTU4ZDU0Zjcz"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 controls mts"><input type="checkbox" name="profile[isWeiboPublic]" />公开</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 controls mts"><input type="checkbox" name="profile[isWeixinPublic]" />公开</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 controls mts"><input type="checkbox" name="profile[isQQPublic]" />公开</div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 controls">
                                    <input type="text" id="varcharField1" name="profile[varcharField1]" class="form-control" value="">
                                    <div class="help-block" style="display:none;"></div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-7 controls">
                                    <input type="text" id="varcharField2" name="profile[varcharField2]" class="form-control" value="">
                                    <div class="help-block" style="display:none;"></div>
                                </div>
                            </div>
